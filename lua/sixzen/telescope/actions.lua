...
(return_statement
  ...
  local query = vim.treesitter.query.get("lua", "plugin_is_disabled")
...
(return_statement
  ...
  local query = vim.treesitter.query.get("lua", "plugin_has_enable_property")
...
local get_return_node = function(bufnr, tree)
  vim.treesitter.query.set(
    "lua",
    "plugin_return_table_constructor",
    [[
(return_statement
  (expression_list
  ...
  local query = vim.treesitter.query.get("lua", "plugin_return_table_constructor")
