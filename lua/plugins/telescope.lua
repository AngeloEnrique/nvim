return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>;p", "<cmd>lua require'telescope'.extensions.project.project{}<CR>", opts)
    ...
    vim.keymap.set("n", "<leader>;gcc", '<cmd>lua require("telescope.builtin").git_commits()<cr>', opts)
    vim.keymap.set("n", "<leader>;gcf", '<cmd>lua require("telescope.builtin").git_bcommits()<cr>', opts)
    vim.keymap.set(
      "n",
      ";c",
